...
--3.Find month over month comparison for 2022 and 2023 sales. eg..jan 2022 vs jan 2023
...
with cte as (
select category, format(order_date,'yyyyMM')as order_yearmonth,sum(sales_price) as sales 
from df_orders
